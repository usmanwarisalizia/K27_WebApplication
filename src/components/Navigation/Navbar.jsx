        ...
        <>
            <div className='z-4 flex fixed top-0 w-full items-start justify-between '>
                ...
                <div
                    ...
                    className="
    h-14 bg-black relative 
    w-32 sm:w-40 md:w-48   /* 📱 mobile & tablet wider */
    lg:w-[16.5vw]          /* 💻 desktop keeps original */
  "
                >
                    <div
                        ref={navGreenRef}
                    ...
                    ></div>
                    <div className="relative h-full px-6 md:px-10 lg:px-12 flex flex-col justify-center items-end gap-2">
                        <div className="w-10 md:w-14 lg:w-18 h-0.5 bg-white"></div>
                        <div className="w-8 md:w-12 lg:w-10 h-0.5 bg-white"></div>
                    </div>
                </div>
